...
%changelog
* Sun Apr 6 2008 Devrim Gunduz <devrim@gunduz.org> 4.2-1
- Update to 4.2
- Removed patch #2

* Wed Jul 11 2007 Devrim Gunduz <devrim@gunduz.org> 4.1.3-2
- Added temporary patch #2 , per sf.net bug #1751614

* Tue Jul 10 2007 Devrim Gunduz <devrim@gunduz.org> 4.1.3-1
- Update to 4.1.3

* Mon Jun 01 2007 Devrim Gunduz <devrim@gunduz.org> 4.1.2-1
- Update to 4.1.2
- Fix for Red Hat Bugzilla  #241489

* Mon Mar 26 2007 Devrim Gunduz <devrim@gunduz.org> 4.1.1-1
- Update to 4.1.1
- Fix for Red Hat Bugzilla  #233902

* Sun Jan 21 2007 Devrim Gunduz <devrim@gunduz.org> 4.1-2
- Rebuilt
- Fixed changelog entry

* Thu Jan 4 2007 Devrim Gunduz <devrim@gunduz.org> 4.1-1
- Update to 4.1
- Fix for rh bugzilla #222740

* Thu Jan 4 2007 Devrim Gunduz <devrim@gunduz.org> 4.0.1-7
- Rebuilt

* Thu Jan 4 2007 Devrim Gunduz <devrim@gunduz.org> 4.0.1-6
- Fixed phppgadmin.conf file.

* Thu Dec 21 2006 Devrim Gunduz <devrim@gunduz.org> 4.0.1-5
- More specfile fixes per bugzilla review #200600

* Thu Dec 21 2006 Devrim Gunduz <devrim@gunduz.org> 4.0.1-4
- More specfile fixes per bugzilla review #200600

* Sun Aug 6 2006 Devrim Gunduz <devrim@gunduz.org> 4.0.1-3
- Changed awk dependency to gawk
- Fixed changelog entry

* Tue Aug 1 2006 Devrim Gunduz <devrim@gunduz.org> 4.0.1-2
- Rebuilt for FC Extras Submission
- Fixed rpmlint errors
- Spec file cleanup

* Tue Dec 17 2005 Devrim Gunduz <devrim@gunduz.org> 4.0.1
- Update to 4.0.1
