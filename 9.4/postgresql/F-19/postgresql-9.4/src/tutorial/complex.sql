...
-- Assume the user defined functions are in /usr/pgsql-9.4/lib/tutorial/complex$DLSUFFIX
...
CREATE FUNCTION complex_in(cstring)
   RETURNS complex
   AS '/usr/pgsql-9.4/lib/tutorial/complex'
...
CREATE FUNCTION complex_abs_lt(complex, complex) RETURNS bool
   AS '/usr/pgsql-9.4/lib/tutorial/complex' LANGUAGE C IMMUTABLE STRICT;
