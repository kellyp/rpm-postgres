...
Source0: 	http://www.gunduz.org/files/replicator/%{name}-%{version}-1.8-beta2.tar.bz2
Source3:	%{name}.init
...
%changelog
* Wed Feb 4 2009 Devrim GUNDUZ <devrim@gunduz.org> 8.1-1.8-beta2
- Add mcp_server under chkconfig management.
- Update to beta2

* Mon Feb 2 2009 Devrim GUNDUZ <devrim@gunduz.org> 8.1.13-1.8_3
- Use Conflicts, instead of Obsoletes.

* Mon Aug 25 2008 Devrim GUNDUZ <devrim@gunduz.org> 8.1.13-1.8_2
- Use better Obsoletes

* Fri Aug 22 2008 Devrim GUNDUZ <devrim@gunduz.org> 8.1.13-1.8_1
