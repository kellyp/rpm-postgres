...
%{!?upstreamserver:%define upstreamver	8.1-415}
...
%changelog
* Mon Oct 4 2010 Devrim Gunduz <devrim@gunduz.org> 0:8.1.415-1PGDG
- Update to build 415

* Tue Aug 4 2009 Devrim Gunduz <devrim@gunduz.org> 0:8.1.414-1PGDG
- Update to build 414

* Fri Nov 28 2008 Devrim Gunduz <devrim@gunduz.org> 0:8.1.413-1PGDG
- Update to build 413

* Thu Jan 31 2008 Devrim Gunduz <devrim@gunduz.org> 0:8.1.412-1PGDG
- Update to build 412

* Tue Jan 1 2008 Devrim Gunduz <devrim@gunduz.org> 0:8.1.411-2PGDG
- Updated gcj_support requires, per Fedora spec file
- Fix buildroot
- Cosmetic cleanup
- Removed unused section macro

* Tue Dec 4 2007 Devrim Gunduz <devrim@gunduz.org> 0:8.1.411-1PGDG
- Update to build 411

* Wed Apr 18 2007 Devrim Gunduz <devrim@gunduz.org> 0:8.1.409-1PGDG
- Update to build 409

* Sun Feb 4 2007 Devrim Gunduz <devrim@gunduz.org> 0:8.1.408-1PGDG
- Update to build 408
