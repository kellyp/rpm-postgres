...
Url:		http://projects.gunduz.org/public/%{name}
Source0:	http://www.gunduz.org/files/odbcng/%{name}-%{version}.tar.gz
...
%changelog
* Mon Aug 25 2008 Devrim GUNDUZ <devrim@gunduz.org> - 0.90.101-2
- Add buildrequires for unixODBC-devel
- Update download URL.

* Sat May 17 2008 Devrim GUNDUZ <devrim@gunduz.org> - 0.90.101-1
