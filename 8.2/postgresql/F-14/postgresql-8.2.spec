...
%changelog
* Mon Dec 5 2011 Devrim GUNDUZ <devrim@gunduz.org> - 8.2.23-1PGDG
- Update to 8.2.23, for various fixes described at
  http://www.postgresql.org/docs/8.2/static/release-8-2-23.html

* Mon Sep 26 2011 Devrim GUNDUZ <devrim@gunduz.org> - 8.2.22-1PGDG
- Update to 8.2.22, for various fixes described at
  http://www.postgresql.org/docs/8.2/static/release-8-2-22.html

* Fri Jan 28 2011 Devrim GUNDUZ <devrim@gunduz.org> - 8.2.20-1PGDG
- Update to 8.2.20, for various fixes described at
  http://www.postgresql.org/docs/8.2/static/release-8-2-20.html

* Wed Dec 15 2010 Devrim GUNDUZ <devrim@gunduz.org> - 8.2.19-1PGDG
- Update to 8.2.19, for various fixes described at
  http://www.postgresql.org/docs/8.2/static/release-8-2-19.html

* Sat Oct 2 2010 Devrim GUNDUZ <devrim@gunduz.org> - 8.2.18-1PGDG
- Update to 8.2.18, for various fixes described at
  http://www.postgresql.org/docs/8.2/static/release-8-2-18.html
  which also fixes CVE-2010-3433.

* Sat May 15 2010  Devrim GUNDUZ <devrim@gunduz.org> 8.2.17-1PGDG
- Update to 8.2.17, for various fixes described at
  http://www.postgresql.org/docs/8.2/static/release-8-2-17.html

* Fri Mar 12 2010  Devrim GUNDUZ <devrim@gunduz.org> 8.2.16-1PGDG
- Update to 8.2.16, for various fixes described at
  http://www.postgresql.org/docs/8.2/static/release-8-2-16.html

* Thu Dec 10 2009 Devrim GUNDUZ <devrim@gunduz.org> 8.2.15-1PGDG
- Update to 8.2.15, for various fixes described at
  http://www.postgresql.org/docs/8.2/static/release-8-2-15.html

* Wed Sep 2 2009 Devrim GUNDUZ <devrim@gunduz.org> 8.2.14-1PGDG
- Update to 8.2.14

* Fri Mar 13 2009 Devrim GUNDUZ <devrim@gunduz.org> 8.2.13-1PGDG
- Update to 8.2.13
- Add perl-ExtUtils-Embed as BR.

* Fri Jan 30 2009 Devrim GUNDUZ <devrim@gunduz.org> 8.2.12-1PGDG
- Update to 8.2.12

* Fri Oct 31 2008 Devrim GUNDUZ <devrim@gunduz.org> 8.2.11-1PGDG
- Update to 8.2.11

* Fri Sep 19 2008 Devrim GUNDUZ <devrim@gunduz.org> 8.2.10-1PGDG
- Update to 8.2.10

* Fri Aug 8 2008 Devrim GUNDUZ <devrim@gunduz.org> 8.2.9-2PGDG
- Update pam file -- current file does not work on recent Fedora releases :-(

* Mon Jun 9 2008 Devrim GUNDUZ <devrim@gunduz.org> 8.2.9-1PGDG
- Update to 8.2.9 (8.2.8 was skipped by upstream)

* Thu Mar 13 2008 Devrim GUNDUZ <devrim@gunduz.org> 8.2.7-1PGDG
- Update to 8.2.7

* Thu Jan 3 2008 Devrim GUNDUZ <devrim@gunduz.org> 8.2.6-1PGDG
...
* Thu Oct 18 2007 Devrim GUNDUZ <devrim@gunduz.org> 8.2.5-4PGDG
- Use perl-devel requirement only for ppc* arches (older RHEL releases
  does not have perl-devel, so we needed this workaround)

* Mon Oct 15 2007 Devrim GUNDUZ <devrim@gunduz.org> 8.2.5-3PGDG
- Build requires perl-devel, per failure on ppc64 builds.

* Sat Sep 22 2007 Devrim GUNDUZ <devrim@gunduz.org> 8.2.5-2PGDG
- Rebuilt with the correct tarball
- 
* Sat Sep 15 2007 Devrim GUNDUZ <devrim@gunduz.org> 8.2.5-1PGDG
- Update to 8.2.5
...
* Thu Jun 21 2007 Devrim GUNDUZ <devrim@gunduz.org> 8.2.4-2PGDG
...
* Sun Nov 26 2006 Devrim GUNDUZ <devrim@gunduz.org> 8.2rc1-1PGDG
- Update to RC1

* Sun Nov 12 2006 Devrim GUNDUZ <devrim@gunduz.org> 8.2beta3-2PGDG
- Added pl/python related parts again.

* Sun Nov 12 2006 Devrim GUNDUZ <devrim@gunduz.org> 8.2beta3-1PGDG
- Update to beta3
...
* Mon Jul 10 2006 Devrim GUNDUZ <devrim@gunduz.org> 8.2beta-1PGDG
