...
%{!?upstreamserver:%define upstreamver	8.2-512}
...
%changelog
* Mon Sep 26 2011 Devrim GÜNDÜZ <devrim@gunduz.org> 0:8.3.512-1PGDG
- Update to build 512

* Mon Oct 4 2010 Devrim Gunduz <devrim@gunduz.org> 0:8.2.511-1PGDG
- Update to build 511.

* Thu Jul 30 2009 Devrim Gunduz <devrim@gunduz.org> 0:8.2.510-1PGDG
- Update to build 510.

* Sat Dec 6 2008 Devrim Gunduz <devrim@gunduz.org> 0:8.2.509-1PGDG
- Update to build 509.

* Thu Jan 31 2008 Devrim Gunduz <devrim@gunduz.org> 0:8.2.508-1PGDG
- Update to build 508

* Tue Jan 1 2008 Devrim Gunduz <devrim@gunduz.org> 0:8.2.507-2PGDG
- Updated gcj_support requires, per Fedora spec file
- Fix buildroot
- Cosmetic cleanup
- Removed unused section macro

* Tue Dec 4 2007 Devrim Gunduz <devrim@gunduz.org> 0:8.2.507-1PGDG
- Update to build 507
