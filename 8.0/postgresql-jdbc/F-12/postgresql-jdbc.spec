...
%changelog
* Sat Sep 12 2009 Devrim Gunduz <devrim@gunduz.org> 0:8.0.324-1PGDG
- Update to build 324

* Sat Dec 6 2008 Devrim Gunduz <devrim@gunduz.org> 0:8.0.323-1PGDG
- Update to build 323                                          

* Thu Jan 31 2008 Devrim Gunduz <devrim@gunduz.org> 0:8.0.322-1PGDG
- Update to build 322

* Tue Jan 1 2008 Devrim Gunduz <devrim@gunduz.org> 0:8.0.321-2PGDG
- Updated gcj_support requires, per Fedora spec file
- Fix buildroot
- Cosmetic cleanup
- Removed unused section macro

* Tue Dec 4 2007 Devrim Gunduz <devrim@gunduz.org> 0:8.0.321-1PGDG
- Update to build 321

* Wed Apr 18 2007 Devrim Gunduz <devrim@gunduz.org> 0:8.0.319-1PGDG
- Update to build 319

* Sun Feb 4 2007 Devrim Gunduz <devrim@gunduz.org> 0:8.0.318-1PGDG
- Update to build 318

* Fri Oct 06 2006 Devrim Gunduz <devrim@gunduz.org> 0:8.0.317-1PGDG
