...
%changelog
* Wed Sep 2 2009 Devrim GUNDUZ <devrim@gunduz.org> 3.0.2-1
- Update to 3.0.2

* Mon Jun 29 2009 Devrim GUNDUZ <devrim@gunduz.org> 3.0.1-1
- Update to 3.0.1

* Tue Dec 2 2008 Devrim GUNDUZ <devrim@gunduz.org> 3.0.0-1
- Update to 3.0.0
- Update gcc 4.3 patch

* Sat Jun 28 2008 Devrim GUNDUZ <devrim@gunduz.org> 2.6.9-1
