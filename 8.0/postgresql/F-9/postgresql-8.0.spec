...
%changelog
* Sat Oct 2 2010 Devrim GUNDUZ <devrim@gunduz.org> 8.0.26-1PGDG
- Update to 8.0.26, for various fixes described at
  http://www.postgresql.org/docs/8.0/static/release.html#RELEASE-8-0-26
  which also fixes CVE-2010-3433.

* Sat May 15 2010 Devrim GUNDUZ <devrim@gunduz.org> 8.0.25-1PGDG
- Update to 8.0.25, for various fixes described at
  http://www.postgresql.org/docs/8.0/static/release.html#RELEASE-8-0-25

* Fri Mar 12 2010 Devrim GUNDUZ <devrim@gunduz.org> 8.0.24-1PGDG
- Update to 8.0.24, for various fixes described at
  http://www.postgresql.org/docs/8.0/static/release.html#RELEASE-8-0-24

* Thu Dec 10 2009 Devrim GUNDUZ <devrim@gunduz.org> 8.0.23-1PGDG
- Update to 8.0.23, for various fixes described at
  http://www.postgresql.org/docs/8.0/static/release.html#RELEASE-8-0-23

* Wed Sep 09 2009 Devrim GUNDUZ <devrim@gunduz.org> - 8.0.22-2PGDG
- Fix init script

* Thu Sep 3 2009 Devrim GUNDUZ <devrim@gunduz.org> 8.0.22-1PGDG
- Update to 8.0.22

* Fri Mar 13 2009 Devrim GUNDUZ <devrim@gunduz.org> 8.0.21-1PGDG
- Update to 8.0.21

* Fri Jan 30 2009 Devrim GUNDUZ <devrim@gunduz.org> 8.0.20-1PGDG
- Update to 8.0.20

* Sat Nov 1 2008 Devrim GUNDUZ <devrim@gunduz.org> 8.0.19-1PGDG
- Update to 8.0.19

* Fri Sep 19 2008 Devrim GUNDUZ <devrim@gunduz.org> 8.0.18-1PGDG
- Update to 8.0.18

* Fri Aug 8 2008 Devrim GUNDUZ <devrim@gunduz.org> 8.0.17-2PGDG
- Update pam file -- current file does not work on recent Fedora releases :-(

* Mon Jun 9 2008 Devrim GUNDUZ <devrim@gunduz.org> 8.0.17-1PGDG
- Update to 8.0.17 (8.0.16 was skipped by upstream)

* Thu Jan 3 2008 Devrim GUNDUZ <devrim@gunduz.org> 8.0.15-1PGDG
...
* Wed Oct 10 2007 Devrim GUNDUZ <devrim@gunduz.org> 8.0.14-2PGDG
- Rebuilt

* Sat Sep 15 2007 Devrim GUNDUZ <devrim@gunduz.org> 8.0.14-1PGDG
- Update to 8.0.14

* Sat Apr 21 2007 Devrim GUNDUZ <devrim@gunduz.org> 8.0.13-1PGDG
- Update to 8.0.13

* Wed Feb 7 2007 Devrim GUNDUZ <devrim@gunduz.org> 8.0.12-1PGDG
- Update to 8.0.12

* Sat Feb 3 2007 Devrim GUNDUZ <devrim@gunduz.org> 8.0.11-1PGDG
- Update to 8.0.11

* Wed Jan 3 2007 Devrim GUNDUZ <devrim@gunduz.org> 8.0.10-1PGDG
- Update to 8.0.10

* Fri Oct 14 2006 Devrim GUNDUZ <devrim@gunduz.org> 8.0.9-3PGDG
- Remove Obsoletes
- Fixed rpmlint warnings and some of the errors
- Cosmetic cleanup
- Splitted python into a seperate rpm

* Fri Oct 06 2006 Devrim GUNDUZ <devrim@gunduz.org> 8.0.9-2PGDG
- Splitted jdbc into a seperate rpm
- Splitted tcl into a seperate rpm

* Fri Oct 06 2006 Devrim GUNDUZ <devrim@gunduz.org> 8.0.9-1PGDG
- Update to 8.0.9

* Tue Jun 06 2006 Devrim GUNDUZ <devrim@gunduz.org> 8.0.8-2PGDG
- re-fix PyGreSQL filenames
- Updated JDBC jars to build 317
- Updated PyGreSQL from 3.8 to 3.8.1

* Mon May 22 2006 Devrim GUNDUZ <devrim@gunduz.org> 8.0.8-1PGDG
- Updated JDBC jars to build 316
- Fix PyGreSQL filenames
- Update to 8.0.8

* Sun Feb 19 2006 Devrim GUNDUZ <devrim@gunduz.org> 8.0.7-2PGDG
- Updated PyGreSQL from 3.7 to 3.8

* Mon Feb 13 2006 Devrim GUNDUZ <devrim@gunduz.org> 8.0.7-1PGDG
- Update to 8.0.7

* Thu Feb 09 2006 Devrim GUNDUZ <devrim@gunduz.org> 8.0.6-2PGDG
- Updated JDBC jars to build 315.

* Mon Jan 09 2006 Devrim GUNDUZ <devrim@gunduz.org> 8.0.6-1PGDG
- 8.0.6-1

* Sun Dec 11 2005 Devrim GUNDUZ <devrim@gunduz.org> 8.0.5-1PGDG
- 8.0.5-1
