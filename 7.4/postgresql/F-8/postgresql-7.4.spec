...
%changelog
* Sat Oct 2 2010 Devrim GUNDUZ <devrim@gunduz.org> 7.4.30-1PGDG
- Update to 7.4.30, for various fixes described at
  http://www.postgresql.org/docs/7.4/static/release.html#RELEASE-7-4-30	,
  which	also fixes CVE-2010-3433.

* Sat May 15 2010 Devrim GUNDUZ <devrim@gunduz.org> 7.4.29-1PGDG
- Update to 7.4.29, for various fixes described at
  http://www.postgresql.org/docs/7.4/static/release.html#RELEASE-7-4-29

* Fri Mar 12 2010 Devrim GUNDUZ <devrim@gunduz.org> 7.4.28-1PGDG
- Update to 7.4.28, for various fixes described at
  http://www.postgresql.org/docs/7.4/static/release.html#RELEASE-7-4-28

* Thu Dec 10 2009 Devrim GUNDUZ <devrim@gunduz.org> 7.4.27-1PGDG
- Update to 7.4.27, for various fixes described at
  http://www.postgresql.org/docs/7.4/static/release.html#RELEASE-7-4-27

* Wed Sep 09 2009 Devrim GUNDUZ <devrim@gunduz.org> - 7.4.26-2PGDG
- Fix init script

* Thu Sep 3 2009 Devrim GUNDUZ <devrim@gunduz.org> 7.4.26-1PGDG
- Update to 7.4.26

* Fri Mar 13 2009 Devrim GUNDUZ <devrim@gunduz.org> 7.4.25-1PGDG
- Update to 7.4.25

* Fri Jan 30 2009 Devrim GUNDUZ <devrim@gunduz.org> 7.4.24-1PGDG
- Update to 7.4.24

* Sat Nov 1 2008 Devrim GUNDUZ <devrim@gunduz.org> 7.4.23-1PGDG
- Update to 7.4.23

* Fri Sep 19 2008 Devrim GUNDUZ <devrim@gunduz.org> 7.4.22-1PGDG
- Update to 7.4.22

* Mon Jun 9 2008 Devrim GUNDUZ <devrim@gunduz.org> 7.4.21-1PGDG
- Update to 7.4.21 (7.4.20 was skipped by upstream) 

* Tue Jan 8 2008 Devrim GUNDUZ <devrim@gunduz.org> 7.4.19-2PGDG
- Add Requires for compat-postgresql-libs-5 for F-8

* Thu Jan 3 2008 Devrim GUNDUZ <devrim@gunduz.org> 7.4.19-1PGDG
...
* Wed Oct 10 2007 Devrim GUNDUZ <devrim@gunduz.org> 7.4.18-2PGDG
- Rebuilt

* Sat Sep 15 2007 Devrim GUNDUZ <devrim@gunduz.org> 7.4.18-1PGDG
- Update to 7.4.18

* Sat Apr 21 2007 Devrim GUNDUZ <devrim@gunduz.org> 7.4.17-1PGDG
- Update to 7.4.17

* Sat Feb 3 2007 Devrim GUNDUZ <devrim@gunduz.org> 7.4.16-1PGDG
- Update to 7.4.16

* Wed Jan 3 2007 Devrim GUNDUZ <devrim@gunduz.org> 7.4.15-1PGDG
- Update to 7.4.15
- Update buildroot tag
- Use only major version number in patches.

* Fri Oct 06 2006 Devrim GUNDUZ <devrim@gunduz.org> 7.4.14-1PGDG
- 7.4.14
...
* Tue Jun 06 2006 Devrim GUNDUZ <devrim@gunduz.org> 7.4.13-2PGDG
- re-fix PyGreSQL filenames
- Updated PyGreSQL from 3.8 to 3.8.1

* Mon May 22 2006 Devrim GUNDUZ <devrim@gunduz.org> 7.4.13-1PGDG
- Fix PyGreSQL filenames
- Update to 7.4.13

* Sun Feb 19 2006 Devrim GUNDUZ <devrim@gunduz.org> 7.4.12-2PGDG
- Updated PyGreSQL from 3.7 to 3.8

* Mon Feb 13 2006 Devrim Gunduz <devrim@gunduz.org> 7.4.12-1PGDG
- Update to 7.4.12

* Mon Jan 9 2006 Devrim Gunduz <devrim@gunduz.org> 7.4.11-1PGDG
- Update to 7.4.11

* Mon Dec 10 2005 Devrim Gunduz <devrim@gunduz.org> 7.4.10-2PGDG
- Update PyGreSQL version to 3.7

* Mon Dec 10 2005 Devrim Gunduz <devrim@gunduz.org> 7.4.10-1PGDG
- Upgrade to 7.4.10
