...
Url:		http://projects.gunduz.org/public/replicator

Source0:	http://files.gunduz.org/replicator/%{name}-%{version}-%{minorversion}.tar.bz2
...
%changelog
* Wed Dec 16 2009 Devrim GUNDUZ <devrim@gunduz.org> 8.3.9-1.8.3-1
- Update to 8.3.9-1.8.3

* Wed Sep 23 2009 Devrim GUNDUZ <devrim@gunduz.org> 8.3.8-1.8.2-1
- Update to 8.3.8-1.8.2

* Wed Aug 26 2009 Devrim GUNDUZ <devrim@gunduz.org> 8.3.7-1.8.1-1
- Update to 8.3.7-1.8.1

* Wed Jul 29 2009 Devrim GUNDUZ <devrim@gunduz.org> 8.3.7-1.8.0-1
- Update to 8.3.7-1.8.0

* Wed Jul 1 2009 Devrim GUNDUZ <devrim@gunduz.org> 8.3-1.8-beta6
- Update to beta 6

* Thu May 28 2009 Devrim GUNDUZ <devrim@gunduz.org> 8.3-1.8-beta5
- Update to beta 5

* Tue May 26 2009 Devrim GUNDUZ <devrim@gunduz.org> 8.3-1.8-beta4
- Update to beta 4
- Update download URL

* Tue Feb 3 2009 Devrim GUNDUZ <devrim@gunduz.org> 8.3-1.8-beta2
- Update to beta 2
- Remove patch 10

* Mon Dec 29 2008 Devrim GUNDUZ <devrim@gunduz.org> 8.3-1.8-beta1.4
- Move pg_config to server package, per Alvaro. This is a Replicator-only
  change.

* Mon Dec 29 2008 Devrim GUNDUZ <devrim@gunduz.org> 8.3-1.8-beta1.3
- Add mcp_server under chkconfig management.
- Remove patch8 -- we no longer use /opt/mammoth directory.

* Fri Dec 26 2008 Devrim GUNDUZ <devrim@gunduz.org> 8.3-1.8-beta1.2
- Fix service name

* Thu Dec 25 2008 Devrim GUNDUZ <devrim@gunduz.org> 8.3-1.8-beta1.1
- Fix dependency errors, per Lou Felix

* Mon Oct 13 2008 Devrim GUNDUZ <devrim@gunduz.org> 8.3-1.8-beta1
