...
Patch2:		%{name}-%{version}-sgml.patch
BuildRoot:	%{_tmppath}/%{name}-%{version}-%{release}-root-%(%{__id_u} -n)
BuildRequires:	postgresql-devel, postgresql-server, byacc, flex
...
%changelog
* Fri Dec 17 2010 Devrim GÜNDÜZ <devrim@gunduz.org> - 2.0.6-2
- Update perl patch to ignore perl-log dependency.

* Wed Dec 15 2010 Devrim Gunduz <devrim@gunduz.org> 2.0.6-1
- Update to 2.0.6
