...
%changelog
* Thu Nov 3 2011 Devrim GUNDUZ <devrim@gunduz.org> 8.3.16-1PGDG
...
* Fri Mar 12 2010 Devrim GUNDUZ <devrim@gunduz.org> 8.3.10-1PGDG_id
- Update to 8.3.10, for various fixes described at
  http://www.postgresql.org/docs/8.3/static/release-8-3-10.html

* Mon Feb 1 2010 Devrim GUNDUZ <devrim@gunduz.org> 8.3.9-1PGDG_id
- Update to 8.3.9

* Sat Sep 5 2009 Devrim GUNDUZ <devrim@gunduz.org> 8.3.8-1PGDG_id
- Update to 8.3.8

* Thu Apr 9 2009 Devrim GUNDUZ <devrim@gunduz.org> 8.3.7-1PGDG_id
- Update to 8.3.7

* Wed Nov 26 2008 Devrim GUNDUZ <devrim@gunduz.org> 8.3.5-2PGDG_id
