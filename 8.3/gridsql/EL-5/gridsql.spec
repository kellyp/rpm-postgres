...
#Source0:	http://dfn.dl.sourceforge.net/sourceforge/%{name}-src-2.0-0.tar.gz
Source0:	http://garr.dl.sourceforge.net/sourceforge/%{name}/%{name}-%{version}-0.tar.gz
Source1:	http://garr.dl.sourceforge.net/sourceforge/%{name}/%{name}-client-%{version}-0.tar.gz
Source2:	http://garr.dl.sourceforge.net/sourceforge/%{name}/%{name}-agent-%{version}-0.tar.gz
