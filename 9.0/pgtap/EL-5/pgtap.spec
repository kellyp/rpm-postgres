...
%{_sbindir}/update-alternatives --install /usr/bin/pg_prove pgtap-prove %{pginstdir}/bin/pg_prove 900
%{_sbindir}/update-alternatives --install /usr/bin/pg_tapgen pgtap-tapgen %{pginstdir}/bin/pg_tapgen 900
